...
class UserController extends Controller
{
    ...
    public static function validationErrorMessages()
    {
        ...
        return [
            ...
            'email.required' => 'Debes ingresar obligatoriamente un correo electrónico Preciso.',
            'email.unique' => 'El correo electrónico Preciso ingresado ya existe en el sistema.',
            'email.email' => 'El correo electrónico Preciso ingresado no tiene un formato válido.',
            'email.max' => 'El correo electrónico Preciso debe tener un máximo de cincuenta (50) caracteres.',
            ...
            'ubigeo_id.required' => 'Debes seleccionar obligatoriamente un distrito.',
            'ubigeo_id.int' => 'El ID del distrito seleccionado no tiene un formato válido.',
            'ubigeo_id.min' => 'El ID del distrito seleccionado es inválido.',
            ...
            'contact_ubigeo_id.int' => 'El ID del distrito del contacto en caso de emergencia seleccionado no tiene un formato válido.',
            'contact_ubigeo_id.min' => 'El ID del distrito del contacto en caso de emergencia seleccionado es inválido.',
