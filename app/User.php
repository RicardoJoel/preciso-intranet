...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    protected const EMAIL_ACT_ACCNT = 'Bienvenido a Preciso® Intranet';
    protected const EMAIL_PSW_RESET = '[Preciso® Intranet] Notificación de restablecimiento de contraseña';
    ...
    protected $fillable = [
        ...
        'contact_mobile', 'contact_phone', 'contact_annex', 'password'
    ];
