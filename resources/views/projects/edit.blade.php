...
<form method="POST" action="{{ route('projects.update',$project->id) }}" role="form" id="frm-proj">
	...
	<div id="div-gen">
		<div class="fila">
			...
			<div class="columna columna-5">
				<input type="text" name="code" id="prop_code" value="{{ old('code',$project->code) }}" readonly>
			</div>
			<div class="columna columna-5">
				<p>Fecha de inicio* :</p>
			</div>
		...
		<div class="fila">
			...
			<div class="columna columna-5">
				...
				<div class="search_field">
					<input type="text" name="customer_ruc" id="customer_ruc" value="{{ old('customer_ruc',$project->customer_ruc) }}" maxlength="11" placeholder="R. U. C." required>
					<a onclick="clearDataCust()"><i class="fa fa-close fa-icon" title="Borrar entrada"></i></a>
				</div>
			</div>
			<div class="columna columna-5d">
				<input type="text" name="customer_name" id="customer_name" value="{{ old('customer_name',$project->customer->nameCode) }}" placeholder=" -- No hay información para mostrar -- " readonly required>
			</div>
			<div class="columna columna-5">
		...
		<div class="fila">
			...
			<div class="columna columna-5d">
				<input type="text" name="user_wholename" id="user_wholename" value="{{ old('user_wholename',$project->accountable->fullnameCode) }}" placeholder=" -- No hay información para mostrar -- " readonly required>
			</div>
			<div class="columna columna-5">
		...
		<div class="fila">
			...
			<div class="columna columna-5f">
				<input type="text" name="name" id="name" value="{{ old('name',$project->name) }}" onkeypress="return checkText(event)" placeholder=" -- Nombre del proyecto* -- " required>
			</div>
		</div>
