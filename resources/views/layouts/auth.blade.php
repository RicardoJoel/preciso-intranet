...
<body>
	<div class="body-login">
		<div class="login">
			<div class="box-login">
				<center>
				<a href="{{ url('/') }}"><img src="{{ asset('images/logo-preciso.png') }}" class="logo"></a>
				</center>
				<p>{{ __('Esto es una intranet. Para acceder a nuestra web corporativa, presiona ') }}<a href="http://preciso.pe/">{{ __('aquí') }}</a>.</p>
                <main>
		...
		<div class="fondo-login">
			<img src="{{ asset('images/inicio.jpg') }}" class="img-responsive">
		</div>
    </div>
    <footer>
