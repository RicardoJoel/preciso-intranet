	...
	<div id="div-lab">
		...
		<div class="fila">
			...
			<div class="columna columna-3">
				...
				<input type="date" name="start_at" id="start_at" value="{{ old('start_at',$user->start_at) }}" required>
			</div>
			<div class="columna columna-3">
	...
	<div id="div-pln">
		<div class="fila">
			...
			<div class="columna columna-3">
				...
				<input type="text" name="bank_account" id="bank_account" maxlength="20" value="{{ old('bank_account',$user->bank_account) }}" onkeypress="return checkNumber(event)" disabled required>
			</div>
			<div class="columna columna-3">
				<label>{{ __('Código de Cuenta Interbancario (CCI)*') }}</label>
				<input type="text" name="cci" id="cci" maxlength="23" value="{{ old('cci',$user->cci) }}" onkeypress="return checkNumber(event)" disabled required>
			</div>
		</div>
		<div class="fila">
			<div class="columna columna-3">
